...
export const frenchCrmMessages = {
  resources: {
    ...
    contacts: {
      ...
      hot: {
        ...
        empty_hint: 'Les contacts avec le statut "Prospect" apparaîtront ici.',
        title: "Prospects",
      },
    },
    deals: {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenue sur EuInvisto.club",
    },
    common: {
      activity: "Activité",
      added: "ajoutée",
    ...
    dashboard: {
      ...
      stepper: {
        install: "Installer EuInvisto.club",
    ...
    profile: {
      inbound: {
        description:
          "Vous pouvez commencer à envoyer des e-mails vers l'adresse de réception de votre serveur, par exemple en l'ajoutant au champ %{field}. EuInvisto.club traitera les e-mails et ajoutera des notes aux contacts correspondants.",
