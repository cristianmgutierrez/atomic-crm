...
CREATE UNIQUE INDEX contacts_document_unique ON public.contacts USING btree (document);

alter table "public"."contacts" add constraint "contacts_document_unique" UNIQUE using index "contacts_document_unique";
